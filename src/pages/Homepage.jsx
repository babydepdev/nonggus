        ...
        <div className="App">
            <div className="container">
                ...
                <div className="outcome-section">
                    <div className="example-outcome"><b>Example Outcome</b></div>
    ...
    return (
        <div>
                ...
                <tbody>
                    {rows.map((row, index) => (
                        <tr key={index}>
                            ...
                            <td className={parseFloat(data[row]["4"]) + parseFloat(data[row]["5"]) > (0.6 * (parseFloat(data[row]["1"]) + parseFloat(data[row]["2"]) + parseFloat(data[row]["3"]) + parseFloat(data[row]["4"]) + parseFloat(data[row]["5"]))) ? "pass" : "failed"}>
            ...
            <div className="bg-white">
                <CSVLink data={transformedData} filename={"score.csv"}><b>Export Score</b></CSVLink>
            </div>
        </div>
    );
};
